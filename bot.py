    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            if message.from_user.id in Config.BANNED_USERS:
                await message.reply_text("ꜱᴏʀʀʏ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ!\n\nContact [Support Group](https://t.me/Ott_Movie_Request_Group)",
                                        disable_web_page_preview=True)
                return
        ...
        if "aboutbot" in cb_data:
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    await cmd.message.edit(
                        text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/Ott_Movie_Request_Group).",
                        disable_web_page_preview=True
                    )
                    return
            if(Config.LAZY_MODE == True):
